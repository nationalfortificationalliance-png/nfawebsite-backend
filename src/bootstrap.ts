...
const FIELD_HINTS: Record<string, Record<string, string>> = {
    ...
    'api::guideline-document.guideline-document': {
        ...
        issuing_organization: 'Organisation that issued this resource. Its logo is shown on the Resources page.',
        access_type: 'How visitors access this resource: Download, Preview, or External Link.',
        external_url: 'Official external page to open when Access type is External Link.',
        reference_number: 'Official reference number, e.g. NIS 121.',
        resource_group: 'Optional subgroup displayed within the issuing organisation, e.g. Flour & Cereals.',
        publication_year: 'Official publication year, used where a full publication date is not available.',
